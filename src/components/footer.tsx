export function Footer() {
  return (
    <footer className="bg-paper text-ink border-t border-line-strong relative overflow-hidden">
      <div className="container-page pt-20 pb-12">
        <div className="grid-12 gap-y-12">
          <div className="col-span-12 md:col-span-5">
            ...
            <p className="mt-6 font-jp-sans text-[14px] leading-[1.9] text-ink-soft max-w-[36ch]">
              未経験でも、つくる側へ。初心者クリエイターのためのキャリアプラットフォーム。
            </p>
          </div>

          <div className="col-span-6 md:col-span-2">
            <div className="label-en text-ink-mute mb-5">Navigate</div>
          ...
          <div className="col-span-6 md:col-span-2">
            <div className="label-en text-ink-mute mb-5">Company</div>
            <ul className="space-y-3 font-jp-sans text-[14px]">
          ...
          <div className="col-span-12 md:col-span-3">
            <div className="label-en text-ink-mute mb-5">Connect</div>
            <ul className="space-y-3 font-jp-sans text-[14px]">
        ...
        <div className="mt-20 pt-7 border-t border-line-strong flex flex-col md:flex-row justify-between gap-4 label-en text-ink-mute">
      ...
      <div
        aria-hidden
        className="font-display font-medium text-ink/[0.06] leading-[0.8] tracking-[-0.05em] text-[clamp(140px,30vw,420px)] whitespace-nowrap select-none pointer-events-none px-[clamp(20px,4vw,56px)]"
        style={{ fontVariationSettings: '"opsz" 144, "SOFT" 50' }}
      >
        <span className="italic">Goody.</span>
      </div>
    </footer>
  );
}
